...
TRAFFIC_SCHEMA = {"date": pl.String, "store_id": pl.Int16, "transaction_count": pl.Int32}
...
OUTPUT_COLUMNS = ["date", "product_id", "store_id", "id", "dataset_split", "sales_count", "is_likely_stockout", "promotion", "product_family", "product_class", "is_perishable", "city", "department", "store_type", "store_cluster", "transaction_count", "year", "month", "day", "day_of_week", "week_of_year", "is_weekend", "oil_price", "oil_price_source_missing", "event_count", "effective_event_count", "is_event_day", "is_effective_event_day", "event_types", "event_scopes", "event_locations", "has_holiday", "is_effective_holiday", "days_until_effective_holiday", "is_1d_before_holiday", "is_2d_before_holiday", "days_since_effective_holiday", "has_transfer", "has_additional", "has_special_event", "has_national_event", "has_regional_event", "has_local_event", "has_effective_national_event", "has_effective_regional_event", "has_effective_local_event", "has_transferred_event"]
