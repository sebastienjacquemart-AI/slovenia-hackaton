...
EVENT_BOOLEAN_COLUMNS = ["is_event_day", "has_holiday", "has_transfer", "has_additional", "has_special_event", "has_national_event", "has_regional_event", "has_local_event", "has_transferred_event"]
OUTPUT_COLUMNS = ["date", "product_id", "store_id", "id", "dataset_split", "sales_count", "promotion", "product_family", "product_class", "is_perishable", "city", "department", "store_type", "store_cluster", "year", "month", "day", "day_of_week", "week_of_year", "is_weekend", "oil_price", "oil_price_source_missing", "event_count", "is_event_day", "event_types", "event_scopes", "event_locations", "has_holiday", "has_transfer", "has_additional", "has_special_event", "has_national_event", "has_regional_event", "has_local_event", "has_transferred_event"]
